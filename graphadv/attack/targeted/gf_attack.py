...
from graphadv.attack.targeted.nettack import compute_alpha, update_Sx, compute_log_likelihood, filter_chisquare
...
class GFA(TargetedAttacker):
    ...
    @staticmethod
    def struct_score(A, X_mean, eig_vals, eig_vec, filtered_edges, K, T, lambda_method="nosum"):
        '''

...
class GradArgmax(TargetedAttacker):
    def __init__(self, adj, x, labels, idx_train=None, idx_val=None,
        ...
        if surrogate is None:
            ...
            assert isinstance(surrogate, SemiSupervisedModel) and surrogate.sparse == True, 'surrogate model should be instance of `graphgallery.SemiSupervisedModel` and accept a sparse form of adjacency matrix `adj`.'

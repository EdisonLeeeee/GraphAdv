...
class PGDPoisoning(UntargetedAttacker):
    ...
    def compute_loss(self, logit):
        ...
        if self.CW_loss:
            ...
            loss = self.loss_fn(self.labels_attack, logit) - self.loss_fn(best_wrong_class, logit)
...
class MinMaxPoisoning(PGDPoisoning):
    ...
    def __init__(self, adj, x, labels, idx_train, idx_val,
    ...
    def attack(self, n_perturbations=0.05, sample_epochs=20,  CW_loss=True, epochs=200, C=0.1,
